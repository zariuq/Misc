		...
		<div id="side" class="noprint"> <!-- cavendish-mw / monobook: column-one -->
			<ul id="nav">
                ...
                ?>
                        ...
                        <!-- Begin a list of badges -->
                        <div id="badges" class="plainlinks">
                            <ul>
                            <li> <!-- flattr micro payments -->
                            <script type="text/javascript">
                                    var flattr_url = 'http://opencog.org';
                                    var flattr_btn='compact';
                            </script>
                            <script src="http://api.flattr.com/button/load.js" type="text/javascript"></script>
                            </li>
                            <!-- ohloh open source code metrics -->
                            <li>
                            <script type="text/javascript" src="http://www.ohloh.net/p/15101/widgets/project_thin_badge.js"></script>
                            </li>
                            </ul>
                        </div>
		</div><!-- end of SIDE div -->
